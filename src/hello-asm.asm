...
.label FORMATION_TOP_SLOT_COUNT = 5
.label FORMATION_MID_SLOT_COUNT = 7
.label FORMATION_BOTTOM_SLOT_COUNT = 9
...
formation_live_min_offset:
  .byte FORMATION_SLOT12_OFFSET
formation_live_max_offset:
  .byte FORMATION_SLOT20_OFFSET
...
formation_slot17_x_hi:
  .byte >(FORMATION_START_X_LO + FORMATION_SLOT17_OFFSET)
formation_slot18_x_lo:
  .byte <(FORMATION_START_X_LO + FORMATION_SLOT18_OFFSET)
formation_slot18_x_hi:
  .byte >(FORMATION_START_X_LO + FORMATION_SLOT18_OFFSET)
formation_slot19_x_lo:
  .byte <(FORMATION_START_X_LO + FORMATION_SLOT19_OFFSET)
formation_slot19_x_hi:
  .byte >(FORMATION_START_X_LO + FORMATION_SLOT19_OFFSET)
formation_slot20_x_lo:
  .byte <(FORMATION_START_X_LO + FORMATION_SLOT20_OFFSET)
formation_slot20_x_hi:
  .byte >(FORMATION_START_X_LO + FORMATION_SLOT20_OFFSET)
...
formation_slot17_alive:
  .byte $01
formation_slot18_alive:
  .byte $01
formation_slot19_alive:
  .byte $01
formation_slot20_alive:
  .byte $01
...
formation_char_row_table:
  .byte FORMATION_CHAR_BAND_TOP_ROW,FORMATION_CHAR_BAND_TOP_ROW,FORMATION_CHAR_BAND_TOP_ROW,FORMATION_CHAR_BAND_TOP_ROW,FORMATION_CHAR_BAND_TOP_ROW,FORMATION_CHAR_BAND_MID_ROW,FORMATION_CHAR_BAND_MID_ROW,FORMATION_CHAR_BAND_MID_ROW,FORMATION_CHAR_BAND_MID_ROW,FORMATION_CHAR_BAND_MID_ROW,FORMATION_CHAR_BAND_MID_ROW,FORMATION_CHAR_BAND_MID_ROW,FORMATION_CHAR_BAND_BOTTOM_ROW,FORMATION_CHAR_BAND_BOTTOM_ROW,FORMATION_CHAR_BAND_BOTTOM_ROW,FORMATION_CHAR_BAND_BOTTOM_ROW,FORMATION_CHAR_BAND_BOTTOM_ROW,FORMATION_CHAR_BAND_BOTTOM_ROW,FORMATION_CHAR_BAND_BOTTOM_ROW,FORMATION_CHAR_BAND_BOTTOM_ROW,FORMATION_CHAR_BAND_BOTTOM_ROW
formation_slot_visual_y_table:
  .byte FORMATION_CHAR_TOP_Y,FORMATION_CHAR_TOP_Y,FORMATION_CHAR_TOP_Y,FORMATION_CHAR_TOP_Y,FORMATION_CHAR_TOP_Y,FORMATION_CHAR_MID_Y,FORMATION_CHAR_MID_Y,FORMATION_CHAR_MID_Y,FORMATION_CHAR_MID_Y,FORMATION_CHAR_MID_Y,FORMATION_CHAR_MID_Y,FORMATION_CHAR_MID_Y,FORMATION_CHAR_BOTTOM_Y,FORMATION_CHAR_BOTTOM_Y,FORMATION_CHAR_BOTTOM_Y,FORMATION_CHAR_BOTTOM_Y,FORMATION_CHAR_BOTTOM_Y,FORMATION_CHAR_BOTTOM_Y,FORMATION_CHAR_BOTTOM_Y,FORMATION_CHAR_BOTTOM_Y,FORMATION_CHAR_BOTTOM_Y
formation_slot_offset_table:
  .byte FORMATION_SLOT0_OFFSET,FORMATION_SLOT1_OFFSET,FORMATION_SLOT2_OFFSET,FORMATION_SLOT3_OFFSET,FORMATION_SLOT4_OFFSET,FORMATION_SLOT5_OFFSET,FORMATION_SLOT6_OFFSET,FORMATION_SLOT7_OFFSET,FORMATION_SLOT8_OFFSET,FORMATION_SLOT9_OFFSET,FORMATION_SLOT10_OFFSET,FORMATION_SLOT11_OFFSET,FORMATION_SLOT12_OFFSET,FORMATION_SLOT13_OFFSET,FORMATION_SLOT14_OFFSET,FORMATION_SLOT15_OFFSET,FORMATION_SLOT16_OFFSET,FORMATION_SLOT17_OFFSET,FORMATION_SLOT18_OFFSET,FORMATION_SLOT19_OFFSET,FORMATION_SLOT20_OFFSET
formation_slot_column_bit_table:
  .byte FORMATION_COLUMN_LEFT_MASK,FORMATION_COLUMN_LEFT_MASK,FORMATION_COLUMN_LEFT_MASK,FORMATION_COLUMN_RIGHT_MASK,FORMATION_COLUMN_RIGHT_MASK,FORMATION_COLUMN_LEFT_MASK,FORMATION_COLUMN_LEFT_MASK,FORMATION_COLUMN_LEFT_MASK,FORMATION_COLUMN_LEFT_MASK,FORMATION_COLUMN_RIGHT_MASK,FORMATION_COLUMN_RIGHT_MASK,FORMATION_COLUMN_RIGHT_MASK,FORMATION_COLUMN_LEFT_MASK,FORMATION_COLUMN_LEFT_MASK,FORMATION_COLUMN_LEFT_MASK,FORMATION_COLUMN_LEFT_MASK,FORMATION_COLUMN_LEFT_MASK,FORMATION_COLUMN_RIGHT_MASK,FORMATION_COLUMN_RIGHT_MASK,FORMATION_COLUMN_RIGHT_MASK,FORMATION_COLUMN_RIGHT_MASK
formation_launch_order_left_first:
  .byte $0f,$0e,$0d,$0c,$10,$11,$12,$13,$14
formation_launch_order_right_first:
  .byte $11,$12,$13,$14,$10,$0f,$0e,$0d,$0c
...
formation_char_render_bit_table:
  .byte %00000001,%00000010,%00000100,%00001000,%00010000,%00100000,%01000000,%10000000,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00
formation_char_render_bit_hi_table:
  .byte $00,$00,$00,$00,$00,$00,$00,$00,%00000001,%00000010,%00000100,%00001000,%00010000,%00100000,%01000000,%10000000,$00,$00,$00,$00,$00
formation_char_render_bit_hi2_table:
  .byte $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,%00000001,%00000010,%00000100,%00001000,%00010000
formation_char_clear_bit_table:
  .byte %11111110,%11111101,%11111011,%11110111,%11101111,%11011111,%10111111,%01111111,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff
formation_char_clear_bit_hi_table:
  .byte $ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,%11111110,%11111101,%11111011,%11110111,%11101111,%11011111,%10111111,%01111111,$ff,$ff,$ff,$ff,$ff
formation_char_clear_bit_hi2_table:
  .byte $ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,%11111110,%11111101,%11111011,%11110111,%11101111
...
formation_char_color_table:
  .byte FLAGSHIP_COLOR,FLAGSHIP_COLOR,FLAGSHIP_COLOR,FLAGSHIP_COLOR,FLAGSHIP_COLOR,ESCORT_COLOR,ESCORT_COLOR,ESCORT_COLOR,ESCORT_COLOR,ESCORT_COLOR,ESCORT_COLOR,ESCORT_COLOR,GRUNT_COLOR,GRUNT_COLOR,GRUNT_COLOR,GRUNT_COLOR,GRUNT_COLOR,GRUNT_COLOR,GRUNT_COLOR,GRUNT_COLOR,GRUNT_COLOR
formation_slot_char_frame_base_table:
  .byte $00,$00,$00,$00,$00,$02,$02,$02,$02,$02,$02,$02,$04,$04,$04,$04,$04,$04,$04,$04,$04
formation_anim_frame_offset_table:
  .byte $00,$01,$00,$01
formation_slot_score_lo_table:
  .byte SCORE_FLAGSHIP_LO,SCORE_FLAGSHIP_LO,SCORE_FLAGSHIP_LO,SCORE_FLAGSHIP_LO,SCORE_FLAGSHIP_LO,SCORE_ESCORT_LO,SCORE_ESCORT_LO,SCORE_ESCORT_LO,SCORE_ESCORT_LO,SCORE_ESCORT_LO,SCORE_ESCORT_LO,SCORE_ESCORT_LO,SCORE_GRUNT_LO,SCORE_GRUNT_LO,SCORE_GRUNT_LO,SCORE_GRUNT_LO,SCORE_GRUNT_LO,SCORE_GRUNT_LO,SCORE_GRUNT_LO,SCORE_GRUNT_LO,SCORE_GRUNT_LO
formation_slot_score_mid_table:
  .byte SCORE_FLAGSHIP_MID,SCORE_FLAGSHIP_MID,SCORE_FLAGSHIP_MID,SCORE_FLAGSHIP_MID,SCORE_FLAGSHIP_MID,SCORE_ESCORT_MID,SCORE_ESCORT_MID,SCORE_ESCORT_MID,SCORE_ESCORT_MID,SCORE_ESCORT_MID,SCORE_ESCORT_MID,SCORE_ESCORT_MID,SCORE_GRUNT_MID,SCORE_GRUNT_MID,SCORE_GRUNT_MID,SCORE_GRUNT_MID,SCORE_GRUNT_MID,SCORE_GRUNT_MID,SCORE_GRUNT_MID,SCORE_GRUNT_MID,SCORE_GRUNT_MID
formation_slot_score_hi_table:
  .byte SCORE_FLAGSHIP_HI,SCORE_FLAGSHIP_HI,SCORE_FLAGSHIP_HI,SCORE_FLAGSHIP_HI,SCORE_FLAGSHIP_HI,SCORE_ESCORT_HI,SCORE_ESCORT_HI,SCORE_ESCORT_HI,SCORE_ESCORT_HI,SCORE_ESCORT_HI,SCORE_ESCORT_HI,SCORE_ESCORT_HI,SCORE_GRUNT_HI,SCORE_GRUNT_HI,SCORE_GRUNT_HI,SCORE_GRUNT_HI,SCORE_GRUNT_HI,SCORE_GRUNT_HI,SCORE_GRUNT_HI,SCORE_GRUNT_HI,SCORE_GRUNT_HI
